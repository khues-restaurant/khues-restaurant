  ...
  return (
    ...
    >
      <TabsContent value="preferences">
        <div className="baseVertFlex relative mt-4 w-full !items-start p-4 transition-all tablet:my-8 tablet:p-8">
                ...
                render={({ field, fieldState: { invalid } }) => (
                  <FormItem className="baseVertFlex relative mt-8 !items-start gap-2 space-y-0">
                    <div className="baseVertFlex !items-start gap-2">
                      ...
                      <FormDescription>
                        Please list any allergies or dietary restrictions you
                        may have.
                      </FormDescription>
                      <FormControl>
                        <Textarea
        ...
        <Accordion
          type="single"
          collapsible
          className="w-full px-4 pb-8 tablet:px-8 tablet:pb-0"
        >
          <AccordionItem value="item-1" className="border-none">
            ...
            <AccordionContent className="baseVertFlex gap-8 p-4 tablet:!flex-row">
