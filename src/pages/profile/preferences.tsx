...
function Preferences() {
  ...
  return (
    <motion.div
      ...
      className="baseVertFlex baseVertFlex relative h-full min-h-[calc(100dvh-5rem-81px)]
      w-full !justify-start bg-offwhite lg:bg-body tablet:min-h-[calc(100dvh-6rem-120px)]
      "
    >
