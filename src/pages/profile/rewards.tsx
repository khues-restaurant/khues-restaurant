      ...
      <AnimatePresence mode="wait">
        ...
        isElegibleForBirthdayReward === undefined ? (
          ...
          >
            ...
            {/* .map() of Your rewards */}
            <div className="baseVertFlex max-w-7xl gap-8 px-4 text-primary tablet:mt-4 tablet:gap-16 tablet:px-8">
        ...
        <div className="baseVertFlex w-full !items-start">
          <div className="baseVertFlex size-full !items-start !justify-between">
            <div className="baseVertFlex !items-start gap-1">
              ...
              {/* Point cost for item */}
              {forBirthdayReward ? (
                <p className="max-w-48 whitespace-normal text-left text-stone-400 supports-[text-wrap]:text-wrap">
                  Free
                </p>
              ) : (
                <p className="max-w-48 whitespace-normal text-left text-sm text-stone-400 supports-[text-wrap]:text-wrap tablet:text-base">
