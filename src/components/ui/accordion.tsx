  ...
  (
    ...
    <AccordionPrimitive.Header className="relative flex">
      <AccordionPrimitive.Trigger
        ref={ref}
        className={cn(
          `flex flex-1 items-center justify-between hover:brightness-75 active:brightness-75 ${useCustomTrigger ? "" : "py-4"} font-medium transition-all hover:underline [&[data-state=open]>svg]:rotate-180`,
          className,
        )}
        {...props}
      >
